...
function drawPong(parsedata: any) {
...
window.addEventListener("keydown", (e) => {
	if (e.key === "ArrowUp") keyPressed.up_p1 = true;
	if (e.key === "ArrowDown") keyPressed.down_p1 = true;	
	if (e.key === "w") keyPressed.up_p2 = true;
	if (e.key === "s") keyPressed.down_p2 = true;
});

window.addEventListener("keyup", (e) => {
	if (e.key === "ArrowUp") keyPressed.up_p1 = false;
	if (e.key === "ArrowDown") keyPressed.down_p1 = false;
	if (e.key === "w") keyPressed.up_p2 = false;
	if (e.key === "s") keyPressed.down_p2 = false;
});
